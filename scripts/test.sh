...
# 
# Test Suite (as of 2026-09-25):
#   - 19 test source files + 1 helper
#   - 247 statically declared test methods
#   - Expected result: 247 tests passing
#
...
echo "   Test Suite: 20 files (19 test + 1 helper), 247 tests"
echo ""
