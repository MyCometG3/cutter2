...
- 1 test helper file
- 247 statically declared `func test...` methods
...
**Static suite size**: 20 files total (19 test source files + 1 helper), **247 statically declared test methods**.
...
**Version**: 1.7
**Status**: Static suite size: 247 test methods across 19 test source files + 1 helper; runtime status depends on the specific test run
